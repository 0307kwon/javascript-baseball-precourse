...
1. 사용자의 잘못된 입력 걸러내기(alert 발생시키기)
     - 사용자가 잘못된 입력 값을 작성한 경우 alert을 이용해 메시지를 보여주고, 재입력할 수 있게 한다.
2. 컴퓨터가 숫자를 임의선택하도록 함
3. 입력에 따라 스트라이크, 볼, 낫띵 출력하기
     - 스트라이크와 볼이 같이 있는 경우 볼을 먼저쓰고, 스트라이크를 쓴다.
4. 사용자가 컴퓨터의 숫자를 맞추면 게임이 종료
5. 게임을 종료한 후 id가 game-restart-button인 버튼을 클릭함으로써 게임을 다시 시작할 수 있다.
